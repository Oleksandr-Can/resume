...
var header = {
  ...
  address: '37 Peremogy Avenue, Kyiv, Ukraine',
}

var footer = {
  social: {
    email: {
      text: 'kokotenko@ukr.net',
      href: 'mailto:kokotenko@ukr.net',
    },
    phone: {
      text: '+380954250052',
      href: 'tel:+380954250052',
    },
    linkedin: {
      text: 'LinkedIn',
      href: 'https://www.linkedin.com/in/kokotenko/',
    },
  },
}
...
router.get('/skills', function (req, res) {
  ...
  res.render('skills', {
    ...
    main: {
      ...
      hobbies: [
        { name: 'Learning', isMain: true },
        { name: 'English', isMain: false },
        { name: 'Play sports', isMain: true },
      ],
    },
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        ...
        { name: 'High school', isEnd: true },
        { name: 'Middle school', isEnd: true },
        { name: 'Elementary school', isEnd: true },
      ],
      certificates: [
        { name: 'IT Developer', id: 1234 },
        { name: 'Creator of Year', id: 2345 },
        { name: 'The best Friend', id: 3456 },
      ],
    },
      ...
      works: [
        {
          ...
          project: [
            {
              name: 'Resume',
              url: null, //'https//resume.com.ua',
              about: 'detail information about project',
              stacks: [
                { name: 'React.js' },
                { name: 'HTML / CSS' },
                { name: 'Node.js' },
